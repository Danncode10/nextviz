...
export function MemoryPopup({ node, onClose, onNodeChange }: MemoryPopupProps) {
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-4 border-b border-zinc-800 shrink-0">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-zinc-500">Configure how the agent retains conversation history.</p>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <MemoryConfig node={draft} onNodeChange={setDraft} />
        </div>
      </div>
    </div>
  );
